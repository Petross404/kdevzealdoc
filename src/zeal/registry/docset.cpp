	...
	m_documentPath{ QDir( m_path ).absoluteFilePath( QStringLiteral( "Contents/Resources/Documents" ) ) }
{
	...
	if ( m_name.isEmpty() )
	{
		...
		{
			m_name = m_title = plist[QString::fromUtf8( InfoPlist::CFBundleName )].toString();
	...
	if ( plist.contains( QString::fromUtf8( InfoPlist::DocSetPlatformFamily ) ) )
		m_keywords << plist[QString::fromUtf8( InfoPlist::DocSetPlatformFamily )].toString();

	if ( plist.contains( QString::fromUtf8( InfoPlist::DashDocSetPluginKeyword ) ) )
		m_keywords << plist[QString::fromUtf8( InfoPlist::DashDocSetPluginKeyword )].toString();
	...
	if ( plist.contains( QString::fromUtf8( InfoPlist::DashDocSetFamily ) ) )
	{
		const QString kw = plist[QString::fromUtf8( InfoPlist::DashDocSetFamily )].toString();
	...
	{
		m_indexFileUrl = createPageUrl( plist[QString::fromUtf8( InfoPlist::DashIndexFilePath )].toString() );
	}
